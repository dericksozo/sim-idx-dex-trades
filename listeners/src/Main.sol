...
contract Triggers is BaseTriggers {
    function triggers() external virtual override {
        ...
        addTrigger(chainAbi(Chains.Ethereum, UniswapV3Pool$Abi()), uniswapV3Listener.UniswapV3Pool$triggerOnSwapFunction());
        ...
        addTrigger(
            ...
            crocSwapListener.HotProxy$triggerOnUserCmdFunction()
        );
        addTrigger(
