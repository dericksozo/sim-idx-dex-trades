...
contract MakerPSMListener is PSM$OnBuyGemFunction, PSM$OnSellGemFunction {
    ...
    function onBuyGemFunction(FunctionContext memory ctx, PSM$BuyGemFunctionInputs memory inputs) external override {
    ...
    function onSellGemFunction(FunctionContext memory ctx, PSM$SellGemFunctionInputs memory inputs) external override {
